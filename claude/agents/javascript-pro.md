...
When invoked:
1. Locate the existing project's `package.json`, build setup, and module system usage
...
Always prioritize code readability, performance, and maintainability while leveraging the latest JavaScript features and best practices. Deliver a short summary of what changed, test coverage, and bundle-size impact rather than a verbose progress narration.
